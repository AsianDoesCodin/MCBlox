...
function updateSharePreview({ title, description, image, url }) {
...
async function loadPublicProfile(userId) {
  ...
  try {
    ...
    updateSharePreview({
      title: `${profile.username || 'Player'} - McBlox`,
      description: `View ${profile.username || 'this creator'}'s published Minecraft games on McBlox.`,
      image: profile.avatar_url || 'https://www.mcblox.online/embed.png?v=20260430',
